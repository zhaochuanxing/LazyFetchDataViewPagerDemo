...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	public interface IconAndTextTabProvider {
		public TabResource getPageTab(int position);
	}

	public static class TabResource {

		public static final int DRAWABLE_POS_LEFT = 1;
		public static final int DRAWABLE_POS_TOP = 2;
		public static final int DRAWABLE_POS_RIGHT = 3;
		public static final int DRAWABLE_POS_BOTTOM = 4;

		private String title;

		private int iconResId;

		private int drawablePosition = DRAWABLE_POS_LEFT;

		public TabResource() {
		}

		public TabResource(String title, int iconResId, int drawablePos) {
			this.title = title;
			this.iconResId = iconResId;
			if (drawablePos >= DRAWABLE_POS_LEFT
					&& drawablePos <= DRAWABLE_POS_BOTTOM) {
				this.setDrawablePosition(drawablePos);
			}
		}
	...
	private int indicatiorPadding = 0;
	...
	public PagerSlidingTabStrip(Context context, AttributeSet attrs,
		...
		indicatiorPadding = (int) TypedValue.applyDimension(
				TypedValue.COMPLEX_UNIT_DIP, indicatiorPadding, dm);
		...
		drawablePadding = a.getDimensionPixelSize(2, drawablePadding);
		...
		indicatiorPadding = a
				.getDimensionPixelSize(
						R.styleable.PagerSlidingTabStrip_pstsIndicatiorPaddingLeftRight,
						indicatiorPadding);
	...
	public void notifyDataSetChanged() {
		...
		for (int i = 0; i < tabCount; i++) {
			...
			if (pager.getAdapter() instanceof IconTabProvider) {
				...
				addIconAndTextTab(i,
						((IconAndTextTabProvider) pager.getAdapter())
								.getPageTab(i));
			} else {
	...
	private void addIconAndTextTab(final int position, TabResource resource) {

		TextView tab = new TextView(getContext());
		tab.setText(resource.getTitle());
		Drawable drawable = getResources().getDrawable(resource.getIconResId());
		drawable.setBounds(0, 0, drawable.getIntrinsicWidth(),
				drawable.getIntrinsicHeight());

		switch (resource.getDrawablePosition()) {
		case TabResource.DRAWABLE_POS_LEFT:
			tab.setCompoundDrawables(drawable, null, null, null);
			break;
		case TabResource.DRAWABLE_POS_TOP:
			tab.setCompoundDrawables(null, drawable, null, null);
			break;
		case TabResource.DRAWABLE_POS_RIGHT:
			tab.setCompoundDrawables(null, null, drawable, null);
			break;
		case TabResource.DRAWABLE_POS_BOTTOM:
	...
	private void updateTabStyles() {
		...
		for (int i = 0; i < tabCount; i++) {
			...
			if (v instanceof LinearLayout) { // to tab with icon and text
	...
	protected void onDraw(Canvas canvas) {
		...
		canvas.drawRect(lineLeft + indicatiorPadding, height - indicatorHeight,
				lineRight - indicatiorPadding, height, rectPaint);
